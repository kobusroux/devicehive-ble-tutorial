...
Simply open provieded example `examples/purifier.html` or [jsFiddle](http://jsfiddle.net/demon_xxi/6w50v3dd/3/) and change configurartion parameters with your values:
